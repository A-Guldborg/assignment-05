...
public class ProgramTests
{
    ...
    {
        //Given
        var brie = new Brie{Name = "Aged Brie", SellIn = 5, Quality = 51};
        _app.Items.Add(brie);
    ...
    {
        // Given
        var brie = new Brie{ Name = "Aged Brie", SellIn = -4, Quality = 40 };
        _app.Items.Add(brie);
    ...
    {
        // Given
        var brie = new Brie{ Name = "Aged Brie", SellIn = 4, Quality = 49 };
        _app.Items.Add(brie);
    ...
    {
        // Given
        var sulfurasAge0Q80 = new Sulfuras { Name = "Sulfuras, Hand of Ragnaros", SellIn = 0, Quality = 80 };
        var sulfurasAge10Q40 = new Sulfuras { Name = "Sulfuras, Hand of Ragnaros", SellIn = 10, Quality = 40 };
        var sulfurasAgeMinus1QMinus1 = new Sulfuras { Name = "Sulfuras, Hand of Ragnaros", SellIn = -1, Quality = -1 };
    ...
    {
        // Given
        var item = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 7, Quality = 40};
        _app.Items.Add(item);
    ...
    {
        // Given
        var item = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 3, Quality = 40};
        _app.Items.Add(item);
    ...
    {
        // Given
        var item = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 12, Quality = 40};
        _app.Items.Add(item);
    ...
    {
        // Given
        var passQ48 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 4, Quality = 48};
        var passQ49 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 4, Quality = 49};
        var passQ50 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 4, Quality = 50};
    ...
    {
        // Given
        var passQ60 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = -2, Quality = 60};
        var passQ40 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = -2, Quality = 40};
        var passQ0 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = -2, Quality = 0};
        var passQMinus10 = new BackstagePass {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = -2, Quality = -10};
    ...
    {
        // Given
        var item = new DefaultItem {Name = "Default Sword", SellIn = 3, Quality = 12};
        _app.Items.Add(item);
    ...
    {
        // Given
        var item = new DefaultItem {Name = "Default Sword", SellIn = -1, Quality = 8};
        _app.Items.Add(item);
    ...
    [Fact]
    public void Test_Conjured_Item_With_Positive_SellIn_Decrements_Q_By_2(){
        // Given
        var item = new Conjured {Name = "Conjured Item", SellIn = 5, Quality = 12};
        _app.Items.Add(item);
    ...
    [Fact]
    public void Test_Conjured_Item_With_Negative_SellIn_Decrements_Q_By_4(){
        // Given
        var item = new Conjured {Name = "Conjured Item", SellIn = -5, Quality = 12};
        _app.Items.Add(item);
        ...
        item.SellIn.Should().Be(-6);
    }

    [Fact]
    public void Test_Conjured_Item_Q_Stops_At_0(){
        // Given
        var item = new Conjured {Name = "Conjured Item", SellIn = -5, Quality = 2};
        _app.Items.Add(item);
